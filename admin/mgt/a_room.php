...
while($rows = mysqli_fetch_assoc($query1)){
 ...
 $r_count2 = mysqli_num_rows($query2);
if ($r_count2 == $r_count){
...
if(isset($_FILES['files'])){
	...
	foreach($_FILES['files']['tmp_name'] as $key => $tmp_name ){
        ...
        $query="INSERT INTO tblroom (ID, RoomType, RoomNumber, Status, Display, file_name, file_size, file_type, CreationDate) VALUES ('', '$r_type', '$r_no', 0, 'ON', '$file_name', '$file_size', '$file_type', CURRENT_TIMESTAMP)";
...
$myr_type = $row['RoomType'];
    ?>  
<option value="<?php echo htmlentities($rows['RoomType']);?>"><?php echo htmlentities($rows['RoomType']);?>(<?php echo $rows['Nrooms']; ?>)</option>
 <?php } ?> 
...
<div class="form-floating mb-3">
<input class="form-control" type="file" name="files[]" id="files[]" />                                                <label for="n_bed">Room Image</label>
                                            </div>
