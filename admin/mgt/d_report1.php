...
if(isset($_POST['Submit']))
 ...
 $rtype=$_POST['rtype'];
   ...
   @ $rpp;        //Records Per Page 
    ...
    if ($cps <> 0) 
    { 
        $prv =  "<a href='d_report1.php?cps=$lps'><Prev</a>"; 
    } 
    else    
    { 
    ...
    $q="Select SQL_CALC_FOUND_ROWS * from tblbooking where Cdate = '$rdate' and RoomType = '$rtype' order by ID ASC limit $cps, $rpp "; 
                        ...
                        <div class="card">
                          <div class="card-body">
                            <div class="d-sm-flex align-items-center mb-4">
                              <h4 class="card-title mb-sm-0">Daily Report: <?php echo $rdate; ?></h4>
                            </div>
                            <div class="table-responsive border rounded p-1">
                              <table class="table">
                                <thead>
                                  <tr>
                                    <th colspan="9" align="left" class="font-weight-bold"><form name="form1" method="post" action="d_report1.php">
                                      <p>
                                        <input type="date" id="rdate" name="rdate"  placeholder = "Select Date" autofocus="autofocus" style="border-color:#900">
                                      </p>
                                      <p>
...
$sql1 = "Select SUM(Amount) from tblbooking where Cdate = '$rdate' and RoomType = '$rtype' and Remark = 'Approved'";
...
?>
    ...
    { 
        ...
        { 
            ...
            echo "  |  <a href='d_report1.php?cps=$cps&lps=$lps'>Next</a>"; 
        } 
    } 
    ?>
                                    </span></td>
