...
$sql1 = "SELECT SUM(Amount) from tblbooking where Remark = 'Approved'";
  $query = mysqli_query($db, $sql1);
  while ($row = mysqli_fetch_assoc($query)) {
	$t_earnings = $row['SUM(Amount)'];  
  }
  $sql2 = "SELECT SUM(AmtPaid) from tblbooking where Remark = 'Approved'";
  $query1 = mysqli_query($db, $sql2);
  while ($row = mysqli_fetch_assoc($query1)) {
	$t_pend = $row['SUM(AmtPaid)'];  
  }
  $t_pending = ($t_earnings - $t_pend);
...
@ $rpp;        //Records Per Page 
    ...
    if ($cps <> 0) 
    { 
        $prv =  "<a href='index.php?cps=$lps'><Prev</a>"; 
    } 
    else    
    { 
    ...
    $q="Select SQL_CALC_FOUND_ROWS * from tblbooking order by ID DESC limit $cps, $rpp "; 
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title mb-sm-0"><marquee behavior="scroll" onMouseOver="this.stop();" onMouseOut="this.start();" scrollamount="3">Total Earnings till Date: <span class="green">&#8358;<?php echo number_format($t_earnings,2); ?></span> | Pending Payment: <span class="redtext">&#8358;<?php echo number_format($t_pending,2); ?></span></marquee></h4>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="content-top-1">
                                <h4 class="text-left text-uppercase" style="color: orange"><a href="n_reservation.php"><b>Reservations</b></a></h4>
                                <div class="row vertical-center-box 
                                vertical-center-box-tablet">
                                 <?php 
                        $sql2 ="SELECT * from  tblbooking where Status = 'Reserved'";
$query2 = mysqli_query($db, $sql2);
$n_booking = mysqli_num_rows($query2);
$sql3 ="SELECT * from  tblbooking";
$query3 = mysqli_query($db, $sql3);
$countn = mysqli_num_rows($query3);
if($countn != 0){
$t_countn = round(($n_booking/$countn)*100);
} else {
$t_countn = 0;	
}
?>
                                    ...
                                    <div class="col-xs-3 mar-bot-15 text-left">
                                        <label class="label bg-green"><?php echo $t_countn; ?>% <i class="fa fa-level-up" aria-hidden="true"></i></label>
                                    </div>
                                    <div class="col-xs-9 cus-gh-hd-pro">
                                        <h2 class="text-right no-margin"><?php echo htmlentities($n_booking);?></h2>
                                    </div>
                                </div>
                                <div class="progress progress-mini">
                                    <div style="width: <?php echo $t_countn; ?>%;" class="progress-bar bg-green"><?php echo $t_countn; ?>%</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="margin-bottom:1px;">
                            <div class="content-top-1">
                                <h4 class="text-left text-uppercase" style="color: red"><a href="n_booking.php"><b>New Booking</b></a></h4>
                                <div class="row vertical-center-box vertical-center-box-tablet">
                                <?php 
                        $sql2 ="SELECT * from  tblbooking where Status='Booked' ";
$query2 = mysqli_query($db, $sql2);
$a_booking = mysqli_num_rows($query2);
$sql3 ="SELECT * from  tblbooking";
$query3 = mysqli_query($db, $sql3);
$counta = mysqli_num_rows($query3);
if($counta != 0){
$t_counta = round(($a_booking/$counta)*100);
} else {
$t_counta = 0;	
}
?>
                                    ...
                                    <div class="text-left col-xs-3 mar-bot-15">
                                        <label class="label bg-red"><?php echo $t_counta; ?>% <i class="fa fa-level-down" aria-hidden="true"></i></label>
                                    </div>
                                    <div class="col-xs-9 cus-gh-hd-pro">
                                        <h2 class="text-right no-margin"><?php echo htmlentities($a_booking);?></h2>
                                    </div>
                                </div>
                                <div class="progress progress-mini">
                                    <div style="width: <?php echo $t_counta; ?>%;" class="progress-bar progress-bar-danger bg-red"><?php echo $t_counta; ?>%</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="content-top-1">
                                <h4 class="text-left text-uppercase" style="color: magenta"><a href="v_checkin.php"><b>Checked In</b></a></h4>
                                <div class="row vertical-center-box vertical-center-box-tablet">
                                 <?php 
                        $sql2 ="SELECT * from  tblbooking where Status='Checkedin' ";
$query2 = mysqli_query($db, $sql2);
$c_booking = mysqli_num_rows($query2);
$sql3 ="SELECT * from  tblbooking";
$query3 = mysqli_query($db, $sql3);
$countc = mysqli_num_rows($query3);
if($countc != 0){
$t_countc = round(($c_booking/$countc)*100);
} else {
$t_countc = 0;	
}
...
?>
                                	       ...
                                	       <div class="text-left col-xs-3 mar-bot-15">
                                        <label class="label bg-blue"><?php echo $t_countc; ?>% <i class="fa fa-level-up" aria-hidden="true"></i></label>
                                    </div>
                                    <div class="col-xs-9 cus-gh-hd-pro">
                                        <h2 class="text-right no-margin"><?php echo htmlentities($c_booking);?></h2>
                                    </div>
                                </div>
                                <div class="progress progress-mini">
                                    <div style="width: <?php echo $t_countc; ?>%;" class="progress-bar bg-blue"><?php echo $t_countc; ?>%</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="content-top-1">
                                <h4 class="text-left text-uppercase" style="color: orange"><a href="v_checkout.php"><b>Check Out</b></a></h4>
                                <div class="row vertical-center-box vertical-center-box-tablet">
                                <?php 
                        $sql2 ="SELECT * from  tblbooking where Status='Checkout' ";
$query2 = mysqli_query($db, $sql2);
$o_booking = mysqli_num_rows($query2);
$sql3 ="SELECT * from  tblbooking";
$query3 = mysqli_query($db, $sql3);
$countout = mysqli_num_rows($query3);
if($countout != 0){
$t_countout = round(($o_booking/$countout)*100);
} else {
$t_countout = 0;	
}

?> 	           <div class="col-xs-3 mar-bot-15 text-left">
                                        <label class="label bg-green"><?php echo $t_countout; ?>% <i class="fa fa-level-up" aria-hidden="true"></i></label>
                                    </div>
                                    <div class="col-xs-9 cus-gh-hd-pro">
                                        <h2 class="text-right no-margin"><?php echo htmlentities($o_booking);?></h2>
                                    </div>
                                </div>
                                <div class="progress progress-mini">
                                    <div style="width: <?php echo $t_countout; ?>%;" class="progress-bar bg-green"><?php echo $t_countout; ?>%</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="margin-bottom:1px;">
                            <div class="content-top-1">
                                <h4 class="text-left text-uppercase" style="color: red"><a href="a_category.php"><b>Add Room Category</b></a></h4>
                                <div class="row vertical-center-box vertical-center-box-tablet">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="content-top-1">
                                <h4 class="text-left text-uppercase" style="color: magenta"><a href="a_room.php"><b>Add Room</b></a></h4>
                                <div class="row vertical-center-box vertical-center-box-tablet">
            ...
            <div class="row">
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title mb-sm-0">All Bookings | <a href="s_bnumber.php">Search Booking Number</a></h4>
