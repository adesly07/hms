...
if(isset($_POST['Submit']))
 ...
 $mdate=$_POST['mdate'];
   ...
   @ $rpp;        //Records Per Page 
    ...
    if ($cps <> 0) 
    { 
        $prv =  "<a href='m_report.php?cps=$lps'><Prev</a>"; 
    } 
    else    
    { 
    ...
    $q="Select SQL_CALC_FOUND_ROWS * from tblbooking where Cmonth = '$mdate' order by ID ASC limit $cps, $rpp "; 
                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive border rounded p-1">
                      <table class="table">
                        <thead>
                          <tr>
                            <th colspan="9" align="left" class="font-weight-bold"><form name="form1" method="post" action="m_report.php">
...
$sql1 = "Select SUM(Amount) from tblbooking where Cmonth = '$mdate' and Remark = 'Approved'";
...
?>
    ...
    { 
        ...
        { 
            ...
            echo "  |  <a href='m_report.php?cps=$cps&lps=$lps'>Next</a>"; 
        } 
    } 
    ?>
                            </span></td>
