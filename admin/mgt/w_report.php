...
if(isset($_POST['Submit']))
 ...
 $edate=$_POST['edate'];
   ...
   @ $rpp;        //Records Per Page 
    ...
    if ($cps <> 0) 
    { 
        $prv =  "<a href='w_report.php?cps=$lps'><Prev</a>"; 
    } 
    else    
    { 
    ...
    $q="Select SQL_CALC_FOUND_ROWS * from tblbooking where Cdate >= '$fdate' and Cdate <= '$edate' order by ID ASC limit $cps, $rpp "; 
                        ...
                        <div class="card">
                          <div class="card-body">
                            <div class="d-sm-flex align-items-center mb-4">
                              <h4 class="card-title mb-sm-0">Weekly Report Between <?php echo $fdate; ?> and  <?php echo $edate; ?></h4>
                            </div>
                            <div class="table-responsive border rounded p-1">
                              <table class="table">
                                <thead>
                                  <tr>
                                    <th colspan="9" align="left" class="font-weight-bold"><form name="form1" method="post" action="w_report.php">
                                      <p>
                                        StartDate <input type="date" id="fdate" name="fdate"  placeholder = "Select Date" autofocus="autofocus" style="border-color:#900">
                                      </p>
                                      <p>EndDate <input type="date" id="edate" name="edate"  placeholder = "Select Date" autofocus="autofocus" style="border-color:#900"></p>
...
$sql1 = "Select SUM(Amount) from tblbooking where Cdate >= '$fdate' and Cdate <= '$edate' and Remark = 'Approved'";
...
?>
                                <tbody>
                                  <tr>
                                    ...
                                    <td align="center"><?php echo $ndays; ?></td>
    ...
    { 
        ...
        { 
            ...
            echo "  |  <a href='w_report.php?cps=$cps&lps=$lps'>Next</a>"; 
        } 
    } 
    ?>
                                    </span></td>
