...
if(isset($_POST['Submit']))
 ...
 $rtype=$_POST['rtype'];
   ...
   @ $rpp;        //Records Per Page 
    ...
    if ($cps <> 0) 
    { 
        $prv =  "<a href='y_report1.php?cps=$lps'><Prev</a>"; 
    } 
    else    
    { 
    ...
    $q="Select SQL_CALC_FOUND_ROWS * from tblbooking where Cyear = '$ydate' and RoomType = '$rtype' order by ID ASC limit $cps, $rpp "; 
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title mb-sm-0">Yearly Report: <?php echo $ydate; ?></h4>
                    ...
                    <div class="table-responsive border rounded p-1">
                      <table class="table">
                        <thead>
                          <tr>
                            <th colspan="9" align="left" class="font-weight-bold"><form name="form1" method="post" action="y_report1.php">
              <input name="ydate" type="text" id="ydate" style="border-color:#900" value="<?php echo date('Y'); ?>">
              <p>&nbsp;</p> <p>
...
$sql1 = "Select SUM(Amount) from tblbooking where Cyear = '$ydate' and Remark = 'Approved' and RoomType = '$rtype'";
...
?>
    ...
    { 
        ...
        { 
            ...
            echo "  |  <a href='y_report1.php?cps=$cps&lps=$lps'>Next</a>"; 
        } 
    } 
    ?>
                            </span></td>
