...
$n_person = mysqli_real_escape_string($db,$_POST['n_person']);	
$r_facility = mysqli_real_escape_string($db,$_POST['r_facility']);
$price = mysqli_real_escape_string($db,$_POST['price']);
$sql1 = "SELECT * from tblcategory where RoomType ='$r_type'";
$query2 = mysqli_query($db, $sql1);
if(mysqli_num_rows($query2)){
	$msg = "Record already exist";  
}else {
	
$sql = "INSERT INTO tblcategory (ID, RoomType, Nrooms, Description, NofPersons, RoomFacility, Price, Date) VALUES ('', '$r_type', '$n_rooms', '$r_desc', '$n_person', '$r_facility', '$price', CURRENT_TIMESTAMP)";
  $query = mysqli_query($db, $sql);
  if($query){
              ...
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                   ...
                   <div class="card-body">
                              <form name="form1" action="a_category.php" method="post">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="r_type" name="r_type" type="text" placeholder="Room Type" required />
                                                <label for="r_type">Room Type</label>
                                            </div><div class="form-floating mb-3">
                                                <input class="form-control" id="n_rooms" name="n_rooms" type="text" placeholder="Number of Rooms" required />
                                                <label for="n_rooms">Number of Rooms</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="r_desc" name="r_desc" type="text" placeholder="Room Description" required />
                                                <label for="r_desc">Room Description</label>
                                            </div>  
                                             <div class="form-floating mb-3">
                                                <input class="form-control" id="n_person" name="n_person" type="number" placeholder="Number of Persons" required />
                                                <label for="n_person">Maximum Number of Persons</label>
                                            </div>  
                                            <div class="form-floating mb-3">
                                            ...
                                            <div class="form-floating mb-3">
                                                <textarea class="form-control" name="r_facility" id="r_facility" cols="45" rows="5" required></textarea>
