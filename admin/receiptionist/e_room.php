...
{
$sn=intval($_GET['id']);
$sql2= "SELECT * FROM tblroom where ID ='$sn'";
...
$sql = "UPDATE tblroom set RoomType = '$r_type', RoomNumber = '$r_no', Display = '$display', CreationDate = CURRENT_TIMESTAMP where ID = '$sn'";
  $query = mysqli_query($db, $sql);
  if($query){
header('location:m_room.php');
  } else {
	$msg = "Error in updating room"; 
  }
}
              ...
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                   ...
                   <div class="card-body">
                              <form name="form1" action="e_room.php" method="post">
                                            <div class="form-floating mb-3">
                                                ...
                                                <input class="form-control" id="r_no" name="r_no" type="text" value="<?php echo $myr_no; ?>"/>
                                                <label for="r_no">Room Number</label>
                                                
                                            </div>
                                            <div class="form-floating mb-3">
                                           <select type="text" name="display" id="display" class="form-control">
