...
?> 	           <div class="col-xs-3 mar-bot-15 text-left">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="margin-bottom:1px;">
                            <div class="content-top-1">
                                <h4 class="text-left text-uppercase" style="color: red"><a href="#"><b>Add Room Category</b></a></h4>
                                <div class="row vertical-center-box vertical-center-box-tablet">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="content-top-1">
                                <h4 class="text-left text-uppercase" style="color: magenta"><a href="#"><b>Add Room</b></a></h4>
                                <div class="row vertical-center-box vertical-center-box-tablet">
