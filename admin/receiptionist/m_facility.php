...
{
$sn=intval($_GET['id']);
$sql2= "delete from tblfacility where ID ='$sn'";
$query = mysqli_query($db, $sql2);
 ...
 @ $rpp;        //Records Per Page 
    ...
    if ($cps <> 0) 
    { 
        $prv =  "<a href='m_facility.php?cps=$lps'><Prev</a>"; 
    } 
    else    
    { 
                      ...
                      <table class="table">
                        <thead>
                          ...
                          <tr>
                            ...
                            <th class="font-weight-bold">Facility Title</th>
...
?>
                        <tbody>
                          <tr>
                            ...
                            <td align="center"><a href="m_facility.php?id=<?php echo $id ?>" onClick="return check_deletion()">Delete</a></td>
                            <td align="center"></td>
                          </tr>
                           <?php } ?>
                          <tr>
