...
$query = mysqli_query($db, $sql2);
 ...
 @ $rpp;        //Records Per Page 
    ...
    if ($cps <> 0) 
    { 
        $prv =  "<a href='m_room.php?cps=$lps'><Prev</a>"; 
    } 
    else    
    { 
    ...
    $q="Select SQL_CALC_FOUND_ROWS * from tblroom order by ID DESC limit $cps, $rpp "; 
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title mb-sm-0">Manage Room </h4>
                      ...
                      <table class="table">
                        <thead>
                          ...
                          <tr>
                            ...
                            <th class="font-weight-bold">Room Description</th>
                            <th class="font-weight-bold">Room Status</th>
                            <th class="font-weight-bold">Created Date</th>
                            <th class="font-weight-bold">Display</th>
...
if ($mystatus == 0){
$status = "<span class='bgreen'>Room available</span>";	
} else {
$status = "<span class='bred'>Room not available</span>";	
}
$imgname = $rows['file_name'];
$img_file = "Rooms_image/".$imgname;
...
?>
                        <tbody>
                          <tr>
                            ...
                            <td><span class="d-none d-sm-table-cell"><img src="<?php echo $img_file; ?>" width="100" height="100"></span></td>
                            <td><?php echo $mydesc; ?></td>
                            <td><?php echo $status; ?></td>
                            <td align="center"><div class="badge badge-success p-2"><?php echo $mydate; ?></div></td>
                            <td align="center"><?php echo $mydis; ?></td>
                            <td align="center"><a href="e_room.php?id=<?php echo $id ?>">Edit</a>
                 </td>
                            <td align="center"><a href="m_room.php?id=<?php echo $id ?>" onClick="return check_deletion()">Delete</a></td>
                          </tr>
                           <?php } ?>
                          <tr>
                            <td colspan="10"><?php
    ...
    { 
        ...
        { 
            ...
            echo "  |  <a href='m_room.php?cps=$cps&lps=$lps'>Next</a>"; 
        } 
    } 
    ?>
                            </span></td>
