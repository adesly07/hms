...
$query = mysqli_query($db, $sql2);
 ...
 @ $rpp;        //Records Per Page 
    ...
    if ($cps <> 0) 
    { 
        $prv =  "<a href='n_booking.php?cps=$lps'><Prev</a>"; 
    } 
    else    
    { 
    ...
    $q="Select SQL_CALC_FOUND_ROWS * from tblbooking where Status = 'Booked' order by ID DESC limit $cps, $rpp "; 
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title mb-sm-0">New Booking</h4>
...
?>
    ...
    { 
        ...
        { 
            ...
            echo "  |  <a href='n_booking.php?cps=$cps&lps=$lps'>Next</a>"; 
        } 
    } 
    ?>
                            </span></td>
