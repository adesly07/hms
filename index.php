...
<section id="hero">
   ...
   <section id="portfolio" class="portfolio">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Rooms</h2>
          <p>We are expert in what we do.</p>
        </div>
 ...
 <?php
		  $sql1 = "SELECT * from tblroom where Display = 'ON' order by ID DESC limit 18";
$query2 = mysqli_query($db, $sql1);
...
$dimg = "<img src='$img_file' border='0' width='800' height='600'>";
        ...
        <div class="row portfolio-container">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="<?php echo $img_file; ?>" width="800" height="600" class="img-fluid" alt="">
