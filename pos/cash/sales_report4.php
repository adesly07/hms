...
$t_amt = "0";
 ...
 @ $rpp;        //Records Per Page 
    ...
    $q="Select SQL_CALC_FOUND_ROWS * from sales where month = '$month' and year = '$year' and cashier = '$myname' order by id ASC limit $cps, $rpp "; 
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
      <tr>
        ...
        <td width="84%" align="right">&nbsp;</td>
              ...
              <div ></div>
               <div> <a href="y_report.php"><img src="assets/img/back.png" width="70" height="47" border="0" /></a>
          </div>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td bgcolor="#CCCCCC"><table width="100%" border="1" align="center" cellspacing="1">
          <tr>
            <td height="30" colspan="15" align="center" bgcolor="#009900" class="stock">SALES REPORT FOR THE MONTH OF <?php echo strtoupper($month); ?>, <?php echo $year; ?></td>
          </tr>
          <tr>
  ...
  while ($row = mysqli_fetch_array($rs)) {
	...
	$cashier = $row ['cashier'];  
	$i_time = $row ['i_time'];  
 $sql4 = "SELECT SUM(amount) from sales where month = '$month' and year = '$year'";
