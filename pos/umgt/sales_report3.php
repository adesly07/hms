...
$t_amt = "0";
 ...
 @ $rpp;        //Records Per Page 
    ...
    $q="Select SQL_CALC_FOUND_ROWS * from sales where month = '$month' and year = '$year' order by id ASC limit $cps, $rpp "; 
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td bgcolor="#CCCCCC"><table width="100%" border="1" align="center" cellspacing="1">
          <tr>
            <td height="30" colspan="15" align="center" bgcolor="#009900" class="stock">GRANT SALES REPORT FOR THE MONTH OF <?php echo strtoupper($month); ?>, <?php echo $year; ?></td>
          </tr>
          <tr>
